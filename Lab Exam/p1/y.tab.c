...
{
  "$end", "error", "$undefined", "Digit", "String", "'&'", "'@'", "'<'",
  "'>'", "'$'", "'i'", "'h'", "'b'", "'c'", "'#'", "'+'", "'-'", "'*'",
  "'/'", "'%'", "'('", "')'", "$accept", "Start", "Fn", "Number", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    38,    64,    60,    62,    36,
     105,   104,    98,    99,    35,    43,    45,    42,    47,    37,
      40,    41
};
# endif
...
{
       2,     0,     1,     4,     6,     8,     9,    10,     0,     0,
      17,    19,    21,    23,    25,    27,    28,     3,    30,     5,
       7,    11,    12,    13,     0,    15,    16,    18,    20,    22,
      24,    26,    29,    14
};
...
{
       2,    18,    32,     0,     3,     4,     5,     6,     7,     8,
       0,     0,     0,     0,     9,    10,    11,    12,    13,    14,
      15,    16,    20,     0,     0,     0,    25,    26,    27,    28,
      29,    30,    31,    21,    22,    23,    24,     0,     0,     0,
       0,    33
};
...
{
       0,    23,     0,     4,     5,     6,     7,     8,     9,    14,
      15,    16,    17,    18,    19,    20,    21,    24,     3,    25,
      25,    10,    11,    12,    13,    25,    25,    25,    25,    25,
      25,    25,     3,    25
};
...
#line 33 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%scout<<%s<<endl;\n",(yyvsp[0].str)->c_str(),indent().c_str()); }
#line 1248 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 34 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%sary[aryPtr]=%d;\n",indent().c_str(),(yyvsp[0].num)); }
...
#line 40 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%scout<<ary[aryPtr]<<endl;\n",indent().c_str()); }
#line 1290 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 41 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%scout<<hex<<ary[aryPtr]<<dec<<endl;\n",indent().c_str()); }
#line 1296 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 42 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%scout<<bitset<16>(ary[aryPtr])<<endl;\n",indent().c_str()); }
...
#line 45 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%sary[aryPtr]=(ary[aryPtr]+%d)%%65536;\n",indent().c_str(),(yyvsp[0].num)); }
...
#line 55 "p1.y" /* yacc.c:1646  */
    { fprintf(out,"%swhile(ary[aryPtr]!=%d) {\n",indent().c_str(),(yyvsp[0].num));nest++; }
